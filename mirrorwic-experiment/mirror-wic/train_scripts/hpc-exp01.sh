...
#$ -o ./output-exp01_dropout0_1_15epochs.txt  #This is where your output and errors are logged.
...
bash ./mirror_wic.sh 1,0 ../train_data/en_magpie_with_context.txt.mirror.wic.re60 bert-base-uncased 0.1

...
#$ -o ./output-exp05-bertram-STR1_dropout0_1_15epochs.txt  #This is where your output and errors are logged.
...
bash ./mirror_wic_bertram_STR1.sh 1,0 ../train_data/en_magpie_STR1_with_context_bertram.txt.mirror.wic.re60 ../input_models/bert-base-uncased_option1_with_bertram 0.1

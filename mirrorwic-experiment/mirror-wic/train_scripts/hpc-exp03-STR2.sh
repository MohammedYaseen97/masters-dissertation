...
#$ -o ./output-exp03-STR2_dropout0_4.txt  #This is where your output and errors are logged.
...
bash ./mirror_wic_STR2.sh 1,0 ../train_data/en_magpie_STR2_with_context.txt.mirror.wic.re60 ../input_models/bert-base-uncased_MaskedLM_STR_option2 0.4
